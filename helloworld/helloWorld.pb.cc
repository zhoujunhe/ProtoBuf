...
static ::_pb::Metadata file_level_metadata_helloworld_2fhelloWorld_2eproto[2];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_helloworld_2fhelloWorld_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_helloworld_2fhelloWorld_2eproto = nullptr;

const uint32_t TableStruct_helloworld_2fhelloWorld_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_helloworld_2fhelloWorld_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "world.HelloReply\"\000\022C\n\rSayHelloAgain\022\030.he"
  ...
  ;
static ::_pbi::once_flag descriptor_table_helloworld_2fhelloWorld_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_helloworld_2fhelloWorld_2eproto = {
    false, false, 311, descriptor_table_protodef_helloworld_2fhelloWorld_2eproto,
    "helloworld/helloWorld.proto",
    &descriptor_table_helloworld_2fhelloWorld_2eproto_once, nullptr, 0, 2,
    schemas, file_default_instances, TableStruct_helloworld_2fhelloWorld_2eproto::offsets,
    file_level_metadata_helloworld_2fhelloWorld_2eproto, file_level_enum_descriptors_helloworld_2fhelloWorld_2eproto,
    file_level_service_descriptors_helloworld_2fhelloWorld_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_helloworld_2fhelloWorld_2eproto_getter() {
  return &descriptor_table_helloworld_2fhelloWorld_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_helloworld_2fhelloWorld_2eproto(&descriptor_table_helloworld_2fhelloWorld_2eproto);
namespace helloworld {
...
::PROTOBUF_NAMESPACE_ID::Metadata HelloRequest::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_helloworld_2fhelloWorld_2eproto_getter, &descriptor_table_helloworld_2fhelloWorld_2eproto_once,
      file_level_metadata_helloworld_2fhelloWorld_2eproto[0]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata HelloReply::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_helloworld_2fhelloWorld_2eproto_getter, &descriptor_table_helloworld_2fhelloWorld_2eproto_once,
      file_level_metadata_helloworld_2fhelloWorld_2eproto[1]);
}
